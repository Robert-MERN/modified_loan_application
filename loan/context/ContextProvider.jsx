...
export const ContextProvider = ({ children }) => {
    ...
    const handle_get_all_app_settings = async (set_app_settings, set_is_loading) => {
        set_is_loading(true)
        try {

            const res = await axios.get("/api/get_all_app_settings");
    ...
    return (
        <StateContext.Provider
            value={{
                ...
                app_settings, set_app_settings, all_app_settings, set_all_app_settings,
