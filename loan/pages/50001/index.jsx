...
const admin = ({ userAgent }) => {
    const { handle_get_all_app_settings, all_app_settings, set_all_app_settings } = useStateContext();

    const [is_loading, set_is_loading] = useState(true);

    useEffect(() => {
        handle_get_all_app_settings(set_all_app_settings, set_is_loading);
    }, []);
    ...
    return (
        <div>
            ...
            <Admin app_settings={all_app_settings} is_loading={is_loading} device_info={userAgent} />
        </div>
    )
}
